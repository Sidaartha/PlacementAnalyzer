...
function drawBar_dep() {
      var data = google.visualization.arrayToDataTable([
		...
		['MI', createCustomHTMLContent('MI', 11.8, 14.3, 46, '#F26469', '#4B759E'), 11.8, 14.3],
...
function drawBar_dep_max() {
      var data = google.visualization.arrayToDataTable([
		...
		['MI', createCustomHTMLContentm('MI', 21.0, 31.5, 46, '#17AF84', '#FFC66A'), 21.0, 31.5],
...
function drawBar_sec() {
    ...
    data.addRows([
		...
		['IT/Software', createCustomHTMLContent('IT/Software', 14.4, 16.6, 427, '#33658A', '#C4D6B0'), 14.4, 18.6],
