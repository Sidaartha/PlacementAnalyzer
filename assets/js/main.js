...
function drawHist_ctc() {
    var data = google.visualization.arrayToDataTable([
		...
		var options = {
	        ...
	        colors: ['#CACAAA'],
	        histogram: {bucketSize: 2},
	        hAxis: {textPosition: 'out', ticks: [4,8,12,16,20,24,28,32,36,40,44,48,52,56,60,64,68,72,76,80,84,88,92,96,100,104,108], textStyle: {bold: true, fontSize: 8.4, color: '#5B5B5B'}},
	        vAxis: {textPosition: 'out', gridlines: {color: 'transparent'}, textStyle: {fontSize: 7, color: '#5B5B5B'}},
	        legend: {position: 'none'}
	      };
